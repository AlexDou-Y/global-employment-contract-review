...
- 新增政治、主权、国家/地区称谓专项审核，覆盖台湾、香港、澳门、争议地区、政府名称、适用法律、司法管辖、公共机关、法律体系名称等表述。
...
- 增加台湾适用法律示例：合同中出现 `Republic of China`、`R.O.C.`、`中华民国` 或 `中華民國` 时，应作为中国语境雇主的政治/主权敏感表述单独提示；如当地法律可行，建议经 Legal/当地律师确认后改为中性的台湾地区表述。
